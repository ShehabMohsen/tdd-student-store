...
export default function Home({ products, setProducts, getDataCategory }) {
...
<div class="subnavbar">
    ...
    <div className="temp">
      <div className="categories">
        <h2 id="category1" onClick={() => {getDataCategory("clothing");}}>
          CLOTHES
        </h2>
        <h2 onClick={() => {getDataCategory("food");}}>
          FOOD
        </h2>
        <h2 onClick={() => {getDataCategory("accessories");}}>
          ACCESSORIES
        </h2>
        <h2 onClick={() => {getDataCategory("tech");}}>
          TECH
        </h2>
      </div>
